...
#Flip direction for subjects with close source at 135
#so positive numbers mean toward pole where source resides (aligned shift)
alshift[out$closebound==135] <- bshift[out$closebound==135] * -1
...
out <- cbind("one15", out) #Add column to indicate the experiment condition (one close)
